...
<div id="wrapper">
<header>
		<img src="images/sample_logo_v3.png" id="head">  
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a class="active" href="#"><span class="glyphicon glyphicon-search"></span>Search</a></li>
	...
	<div id = "recentTable">
		<table >
			...
			<tr>
				<td> <input type="text" name="Search_basic_full"></td><td><input type="button" value="Search"></td>
			</tr>
