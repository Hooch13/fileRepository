...
<?php
error_reporting(E_ALL);//Used to disable errors thrown by empty values submitted through optoinal subject/course/specialties
ini_set('display_errors', 1);
$assignmentNum = $_GET['id'];//Get the ID of the assignment to Edit.
$_SESSION['editAssignment']= $assignmentNum;
?>
...
<body></body>
<div class="container">
    <strong><h2>Update an assignment</h2></strong>

    <form action="fileEditor.php" method="post" enctype="multipart/form-data" >
        <div class="panel panel-default">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="form-group" id="subjectDivInner">
                        ...
                        <select required multiple class="form-control" id="subject" name="subject[]">
                            ...
                            $wipeInter = "DELETE FROM tAssignment_IntermediateSSC WHERE AssignmentID = $editAssignmentID";
                            $wipetAssignment = "DELETE FROM tAssignment WHERE AssignmentID = $editAssignmentID";
                            //$deleted = $dbc->query($wipeString);
            ...
            <div class="panel panel-default">
               ...
               <!-- <div class="row">
                ...
                <div class="panel-heading">
                    <strong><kbd>Edit your assignment:</kbd></strong>
                </div>
                <div class="panel-body">
                ...
                <?php
                $toEdit = "Select * FROM tAssignment WHERE AssignmentID = $assignmentNum ";
                $results = $dbc->query($toEdit);
                    while ($row = $results->fetch_array()) {

                        echo '<h4 style="color:red">'. $row['Title']. '</h4>';
